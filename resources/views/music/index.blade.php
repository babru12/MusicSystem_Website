		...
		<div class="wrapper" id="home">
					...
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="#home">
								<!-- logo image -->
								<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/logo/logo.png" alt="" />
							</a>
						</div>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="#featuredalbum">Add Music</a></li>
								<li><a href="#">Edit Music</a></li>
								<li><a href="#joinus">Join Us</a></li>
								<li><a href="#portfolio">Add Album</a></li>
								<li><a href="#events">Edit Album</a></li>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="{{url('/')}}/melodi/HTML/img/banner/b1.jpg" alt="...">
							<div class="container">
								<!-- banner caption -->
						...
						<div class="item">
							<img src="{{url('/')}}/melodi/HTML/img/banner/b2.jpg" alt="...">
							<div class="container">
								<!-- banner caption -->
					...
					<div class="hero-playlist">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								...
								<div class="figure">
									<!-- image -->
									<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/album/1.jpg" alt="" />
									<!-- disk image -->
									<img class="img-responsive disk" src="{{url('/')}}/melodi/HTML/img/album/disk.png" alt="" />
								</div>
								<!-- album details -->
			...
			<div class="featured pad" id="featuredalbum">
				<div class="container">
					...
					<div class="default-heading">
						...
						<!-- <form action="">
                          name of music::<input type="text" name ="name" id="name">
						  <input type="file">
						</form> -->
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								...
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/featured/1.jpg" alt="" />
										<!-- paragraph -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/featured/2.jpg" alt="" />
										<!-- paragraph -->
										<p>There are many variations of passages available, but the majority have suffered Lorem alteration in some form, by injected look even slightly believable.</p>
									</div>
									<!-- featured information -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/featured/3.jpg" alt="" />
										<!-- paragraph -->
										<p>There are many variations of passages available, but the majority have suffered Lorem alteration in some form, by injected look even slightly believable.</p>
									</div>
									<!-- featured information -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/featured/4.jpg" alt="" />
										<!-- paragraph -->
										<p>There are many variations of passages available, but the majority have suffered Lorem alteration in some form, by injected look even slightly believable.</p>
									</div>
									<!-- featured information -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/featured/5.jpg" alt="" />
										<!-- paragraph -->
										<p>There are many variations of passages available, but the majority have suffered Lorem alteration in some form, by injected look even slightly believable.</p>
									</div>
									<!-- featured information -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/featured/6.jpg" alt="" />
										<!-- paragraph -->
										<p>There are many variations of passages available, but the majority have suffered Lorem alteration in some form, by injected look even slightly believable.</p>
									</div>
									<!-- featured information -->
			...
			<div class="portfolio pad" id="portfolio">
				...
				<div class="portfolio-content" id="portfolioOwl">
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/1.jpg" alt="">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/2.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/3.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/4.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/5.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/6.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/7.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/portfolio/8.jpg" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="events-item ">
									...
									<div class="figure">
										...
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/event/1.jpg" alt="" />
										<!-- image hover -->
										<div class="img-hover">
											<!-- hover icon -->
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="events-item ">
									...
									<div class="figure">
										...
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/event/2.jpg" alt="" />
										<!-- image hover -->
										<div class="img-hover">
											<!-- hover icon -->
											<a href="#"><i class="fa fa-play-circle"></i></a>
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="events-item ">
									...
									<div class="figure">
										...
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/event/3.jpg" alt="" />
										<!-- image hover -->
										<div class="img-hover">
											<!-- hover icon -->
											<a href="#"><i class="fa fa-play-circle"></i></a>
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="events-item ">
									...
									<div class="figure">
										...
										<span class="event-location"><i class="fa fa-map-marker"></i> New Delhi</span>
										<!-- image -->
										<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/event/4.jpg" alt="" />
										<!-- image hover -->
										<div class="img-hover">
											<!-- hover icon -->
											<a href="#"><i class="fa fa-play-circle"></i></a>
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-one">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/user/1.jpg" alt="" />
											<!-- Hover block -->
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-two">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/user/2.jpg" alt="" />
											<!-- Hover block -->
											<div class="social text-center">
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-google-plus"></i></a>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-three">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/user/3.jpg" alt="" />
											<!-- Hover block -->
											<div class="social text-center">
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-google-plus"></i></a>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-four">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/user/4.jpg" alt="" />
											<!-- Hover block -->
											<div class="social text-center">
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-google-plus"></i></a>
			...
			<div class="meet parallax-four pad" id="meet">
				<div class="container">
					...
					<!-- meet location image -->
					<div class="meet-map">
						<img class="img-responsive img-map" src="{{url('/')}}/melodi/HTML/img/flat/map.png" alt="" />
						<!-- map marker for India  -->
						<a href="#" class="map-marker india " data-toggle="tooltip" data-placement="top" title="India"><img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/flat/map-marker.png" alt="" /></a>
						<!-- map marker for United States  -->
						<a href="#" class="map-marker usa " data-toggle="tooltip" data-placement="top" title="United States"><img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/flat/map-marker.png" alt="" /></a>
						<!-- map marker for South Africa  -->
						<a href="#" class="map-marker sa " data-toggle="tooltip" data-placement="top" title="South Africa"><img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/flat/map-marker.png" alt="" /></a>
						<!-- map marker for Russia  -->
						<a href="#" class="map-marker russia " data-toggle="tooltip" data-placement="top" title="Russia"><img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/flat/map-marker.png" alt="" /></a>
						<!-- map marker for Brazil  -->
						<a href="#" class="map-marker brazil " data-toggle="tooltip" data-placement="top" title="Brazil"><img class="img-responsive" src="{{url('/')}}/melodi/HTML/img/flat/map-marker.png" alt="" /></a>
					</div>
				</div>
			</div>
			<!-- meet end -->
			...
			<footer>
				<div class="container">
					...
					<!-- copy right -->
					<p class="copy-right">&copy; completely made by babru.</p>
				</div>
			</footer>
			<!-- footer end -->
