...
<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/music_player/font-awesome/css/all.min.css">
    <link rel="stylesheet" href="{{url('/')}}/music_player/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('/')}}/music_player/css/styles.css">
    <script src="{{url('/')}}/music_player/font-awesome/js/all.min.js"></script>
    <script src="{{url('/')}}/music_player/js/jquery-3.6.0.min.js"></script>
    <script src="{{url('/')}}/music_player/js/popper.min.js"></script>
    <script src="{{url('/')}}/music_player/js/bootstrap.min.js"></script>
    <script src="{{url('/')}}/music_player/js/script.js"></script>
</head>
